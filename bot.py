...
class Bot(Client):
    ...
    async def start(self):
        try:
            ...
            self.LOGGER(__name__).info(
                "Bot Berhenti. Gabung Group https://t.me/musik_supportdan untuk Bantuan"
            )
            sys.exit()
        ...
        self.LOGGER(__name__).info(
            f"[🔥 BERHASIL DIAKTIFKAN! 🔥]\n\nBOT Dibuat oleh @mhmdwldnnnn\nJika @mhmdwldnnnn Membutuhkan Bantuan, Silahkan Tanyakan di Grup https://t.me/musik_supportdan"
        )
